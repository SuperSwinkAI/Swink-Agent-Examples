# local/gemma4-e2b/basic

Run a multi-turn conversation entirely on-device using Gemma 4 E2B (2-billion
effective-parameter model from Google).

## What it does

Sends two prompts to a local Gemma 4 E2B agent and prints each reply. The
