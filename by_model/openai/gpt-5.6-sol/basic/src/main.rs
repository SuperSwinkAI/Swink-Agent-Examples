...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let connection = build_remote_connection_for_model("gpt-5.6-sol")?;
    ...
    for prompt in [
        "You're GPT-5.6 Sol running via the OpenAI API. What genuinely new agentic capabilities do you have that GPT-4o lacked — be specific, skip the marketing?",
